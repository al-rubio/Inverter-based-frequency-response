...
MODEL               = a1_IEEE9_Ctest
MODULES             = rt_matrx.c rt_printf.c rt_logging.c a1_IEEE9_Ctest.c a1_IEEE9_Ctest_capi.c a1_IEEE9_Ctest_data.c a1_IEEE9_Ctest_tgtconn.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_psbdqc.c
MAKEFILE            = a1_IEEE9_Ctest.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/Alejandro/DOCUME~1/Thesis PPRE/MATLAB_SIMULINK/A1_Simulations/IEEE9/SIMSCAPE model
...
BUILDARGS           =  MODELLIB=a1_IEEE9_Ctestlib.lib RSIM_SOLVER_SELECTION=2 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = a1_IEEE9_Ctest_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/a1_IEEE9_Ctest \
...
%.obj : $(START_DIR)/slprj/raccel/a1_IEEE9_Ctest/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
...
rt_matrx.obj : C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_matrx.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_matrx.c

rt_printf.obj : C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_printf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019a\rtw\c\src/rt_printf.c
...
sfun_psbdqc.obj : C:\Program\ Files\MATLAB\R2019a\toolbox\physmod\powersys\powersys/sfun_psbdqc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\MATLAB\R2019a\toolbox\physmod\powersys\powersys/sfun_psbdqc.c
...
%.obj : $(START_DIR)/slprj/raccel/a1_IEEE9_Ctest/%.cpp
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
