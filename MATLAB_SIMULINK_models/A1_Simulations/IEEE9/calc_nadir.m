...
clear
data1=xlsread('Gov_data.xlsx','P:P'); %Generator selection
...
for un=0.01:0.02:0.4
    count=count+1;
    sim('A1MODEL_Synthetic_Inv_Resp_delay','ReturnWorkspaceOutputs','on');
    frqy=ans.Freq.data(:);
    nadir=min(frqy);
